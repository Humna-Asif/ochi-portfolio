...
function navbar() {
  return (
    <div
      className='fixed z-[999] w-full px-20 py-4 flex justify-between items-center bg-zinc-900 bg-opacity-45 border-b-[1px] border-zinc-600 '
      style={{
    ...
    >
      ...
      <div className='Links flex gap-8'>
        {["Services", "About Us", "Our Work", "Insights", "Contact"].map(
          (item, index) => (
            <a
              key={index}
